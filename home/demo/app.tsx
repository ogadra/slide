                ...
                <div class={contentClass}>
                    ...
                    <ul class={demoListClass}>
                        <li class={demoItemClass}>
                            <a href="/demo/ios-safari-app-experience" class={demoLinkClass}>Safariでもネイティブアプリの触り心地を実現したい！</a>
                        </li>
                    </ul>
                </div>
                <a href="/" class={backLinkClass}>← トップページに戻る</a>
            </main>
            <footer class={footerClass}>
                <div class={footerLinksClass}>
                    <a href="https://twitter.com/const_myself" target="_blank" rel="noopener noreferrer" class={footerLinkClass}>Twitter</a>
                    <a href="https://github.com/ogadra/slide" target="_blank" rel="noopener noreferrer" class={footerLinkClass}>このページのGitHub</a>
                </div>
